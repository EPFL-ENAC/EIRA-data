# EIRA-data Contributing Guide

Hi! Thanks for taking the time to contribute to EIRA-data.

_You can contribute in many ways_

- Join the [discussion](https://github.com/EPFL-ENAC/EIRA-data/discussions)

_Before submitting your contribution, please make sure to take a moment and read through the following guidelines_

- [Code of Conduct](https://github.com/EPFL-ENAC/EIRA-data/blob/main/CODE_OF_CONDUCT.md)
...
- Always use [ issue templates ](https://github.com/EPFL-ENAC/EIRA-data/issues/new/choose)
...
Thank you to all the people who have already contributed to EIRA-data repository!
